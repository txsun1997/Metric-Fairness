...
from utils import (bert_cos_score_idf, cache_scibert,  # get_hash,
                   get_bert_embedding, get_idf_dict, get_model, get_tokenizer,
...
class BERTScorer:
    ...
    def __init__(
        ...
        if adapter_path:
            self._model.load_adapter(adapter_path,set_active=True)
